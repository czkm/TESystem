...
<body>
<form class="layui-form" action="${contextpath }/criteriaclasses/edit.do"  method="post">
<input type="hidden" name="id" value="${criteria.id}">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="weight" value="${criteria.weight }" required  lay-verify="required" placeholder="权重" autocomplete="off" class="layui-input">
    </div>
  </div>
