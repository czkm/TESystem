...
<table class="layui-table">
 ...
 <c:forEach items="${configs }" var="config">
    <tr>
      <td><input type="text" class="layui-input ${config.incType }" id="${config.name }" value="${config.value }"  placeholder="${config.value }"></td>
      <td><a href="javascript:;" id="${config.name }"  onclick="changetime(${config.id },this)">修改${config.name }</a></td>
    </tr>
	...
	function changetime(id,obj){
		...
		var time=$("#"+obj.id).val();
		  ...
		  $.ajax({
			  ...
			  url:"${contextpath }/config/changetime",
			  dataType:"json",
			  beforeSend:function(){
		    		layer.load(); //上传loading
		    	},
